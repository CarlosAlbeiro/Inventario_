...
// Listar categorias
categorias.get("/listarCategorias", async (req, res) => {
  try {
...
// Crear categoría
categorias.post("/crearCategoria", async (req, res) => {
...
categorias.post("/actualizarCategoria", async (req, res) => {
...
categorias.post("/deshabilitarCategoria", async (req, res) => {
...
// Eliminar categoría
categorias.post("/eliminarCategoria", async (req, res) => {
  const {id_Categoria} = req.body;
  try {
    conexion.query(
